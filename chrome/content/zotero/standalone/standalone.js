...
const ZoteroStandalone = new function () {
  ...
  this.onLoad = function () {
    ...
    try {
      console.log("HIHIHI", Zotero);
      if (Zotero.isDebugging) {
        const { DebuggerServer } = ChromeUtils.import("resource://devtools/server/main.js");
        // Lazy loading in Gecko
        // Initialize once
        ...
        DebuggerServer.openListener(6000); // Or 6001 if preferred
        Zotero.debug("✅ DebuggerServer is listening on port 6000");
      }
    } catch (e) {
      Zotero.debug("❌ Failed to initialize DebuggerServer", 1);
      Zotero.logError(e);
    }
  }
